...
echo ============================================================
echo  FlipClock V0.6.6 - Nuitka Standalone 建置
...
echo.
echo 建置完成：
echo %~dp0build_standalone\FlipClock_V0.6.6.dist\FlipClock_V0.6.6.exe
start "" "%~dp0build_standalone\FlipClock_V0.6.6.dist"
pause
exit /b 0
