# -*- coding: utf-8 -*-
"""
鐵路翻牌時鐘 FlipClock V0.6.6

Windows Nuitka 專案參數：
直接執行「python -m nuitka FlipClock_V0.6.6.py」即可產生單一 EXE。
"""
...
#    nuitka-project: --output-filename=FlipClock_V0.6.6.exe
#    nuitka-project: --remove-output
#    nuitka-project: --assume-yes-for-downloads
#    nuitka-project: --python-flag=no_docstrings
#    nuitka-project: --file-version=0.6.6.0
#    nuitka-project: --product-version=0.6.6.0
#    nuitka-project: --product-name=FlipClock
#    nuitka-project: --file-description=Railway Flip Clock
#    nuitka-project: --report={MAIN_DIRECTORY}/build/FlipClock_V0.6.6_compilation-report.xml
...
APP_NAME = "鐵路翻牌時鐘"
VERSION = "V0.6.6"
ICON_FILENAME = "FlipClock_V0.6.6.ico"
